...
- 現在の検証済み修正: **118 / 455 finding、40 / 139 finding-file**（Wave 1/2を継続中、Wave 3はCI timing／normal-ciの5件を完了）。
- Wave 1: **105 / 222 finding、33ファイル**。Wave 2: **8 / 110 finding、5ファイル**。Wave 3: **5 / 123 finding、2ファイル（timing.py、normal-ci.yml完了）**。
...
|---|---|---:|---:|---|---|
| Wave 1 | Rust runtime、settings、worker、server、contracts、Rust tests | 65 | 222 | 部分完了（105/222） | realtime_connection focused compile/test passed; signed commits continue |
