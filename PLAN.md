...
- [ ] `CURRENT_IMPLEMENTATION_REVIEW.md`の確定finding 455件・139ファイルを、tracked `REVIEW_REMEDIATION.md`のWave 1–3台帳で実装修正・検証・commit・pushまで追跡する（現時点の検証済み修正: 112/455 finding、40/139 finding-file）。
- [ ] Wave 1: Rust runtime、settings、worker、server、contracts、Rust tests（222件・65ファイル、現時点で99 findings/33 filesを修正または部分修正）。
