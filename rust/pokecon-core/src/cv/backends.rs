...
mod v4l_impl {
    ...
    use crate::cv::camera::{CameraBackend, CameraConfig, CameraError, Frame, PixelFormat};
...
mod tests {
    use super::*;
    use crate::cv::camera::CameraBackend;
    ...
    async fn test_v4l_open_virtual_device() {
        ...
        let config = crate::cv::camera::CameraConfig {
            device_index: dev_index,
            width: 640,
            height: 480,
            fps: 15,
            flip: crate::cv::camera::FlipMode::None,
        };
