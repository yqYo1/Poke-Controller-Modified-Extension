...
本仕様に記載されている「今後のバージョンで実装予定」の機能は、現在の設計に拡張性を持たせることを要件とします。これらの将来機能は、各機能の該当する章に分散して記載されています。§15 はこれらの索引・参照先であり、将来機能の詳細は各章を参照してください。将来機能の実装時には、該当する章の記載に従って実装してください。
...
> **本セクションは索引・参照先です。**
> 将来機能の詳細は、各機能の該当する章に分散して記載されています。以下は主要な将来機能の一覧と参照先です。実装時には該当する章の記載に従ってください。
