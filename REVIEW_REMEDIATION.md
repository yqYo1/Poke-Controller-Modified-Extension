...
- 現在の検証済み修正: **132 / 455 finding、42 / 139 finding-file**（Wave 1/2を継続中、Wave 3はCI timing／normal-ciの11件を完了）。
- Wave 1: **113 / 222 finding、34ファイル**。Wave 2: **8 / 110 finding、5ファイル**。Wave 3: **11 / 123 finding、3ファイル（timing.py、normal-ci.yml、build_runtime.py部分完了）**。
...
| Wave 3 | flake、CI、scripts、release、Python/tests | 37 | 123 | 部分完了（11/123） | timing p95 bootstrap、normal-ci timeout/action SHA、build_runtime artifact boundary、contract-sync・mutation・Nix contract passed |
