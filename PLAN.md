...
- [ ] `CURRENT_IMPLEMENTATION_REVIEW.md`の確定finding 455件・139ファイルを、tracked `REVIEW_REMEDIATION.md`のWave 1–3台帳で実装修正・検証・commit・pushまで追跡する（現時点の検証済み修正: 146/455 finding、45/139 finding-file）。
...
- [ ] Wave 3: flake、CI、scripts、release、Python/tests（123件・37ファイル、現時点で25 findings/6 filesを修正）。
