...
class isContainTemplate_sample(ImageProcPythonCommand):
    ...
    def do(self):
        ...
        res = self.isContainedImage(
            os.path.join(os.path.dirname(__file__), "capture_image.png"),
            crop_template=[944, 224, 1141, 414],
        ...
        self.saveCapture(
            os.path.join(os.path.dirname(__file__), "capture_image"),
            crop=[267, 112, 825, 490],
        )
        res = self.isContainedImage(
            os.path.join(os.path.dirname(__file__), "capture_image.png"),
            crop_template=[944, 224, 1141, 414],
