...
- [ ] `CURRENT_IMPLEMENTATION_REVIEW.md`の確定finding 455件・139ファイルを、tracked `REVIEW_REMEDIATION.md`のWave 1–3台帳で実装修正・検証・commit・pushまで追跡する（現時点の検証済み修正: 154/455 finding、50/139 finding-file）。
- [ ] Wave 1: Rust runtime、settings、worker、server、contracts、Rust tests（222件・65ファイル、現時点で113 findings/34 filesを修正または部分修正）。
- [ ] Wave 2: API、Python typings、Web、frontend tests（110件・37ファイル）。
- [ ] Wave 3: flake、CI、scripts、release、Python/tests（123件・37ファイル、現時点で33 findings/11 filesを修正）。
