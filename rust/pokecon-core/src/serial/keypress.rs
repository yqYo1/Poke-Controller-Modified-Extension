use crate::serial::format::SendFormat;
use crate::serial::keys::{Button, Direction, GamepadInput, Hat, Stick, Tilt, Touchscreen};
use crate::serial::sender::Sender;
use tracing::warn;
...
impl KeyPress {
    ...
    pub async fn neutral(&mut self) -> Result<(), crate::serial::sender::SerialError> {
