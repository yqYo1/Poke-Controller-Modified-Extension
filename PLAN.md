...
- [ ] `CURRENT_IMPLEMENTATION_REVIEW.md`の確定finding 455件・139ファイルを、tracked `REVIEW_REMEDIATION.md`のWave 1–3台帳で実装修正・検証・commit・pushまで追跡する（現時点の検証済み修正: 121/455 finding、41/139 finding-file）。
- [ ] Wave 1: Rust runtime、settings、worker、server、contracts、Rust tests（222件・65ファイル、現時点で108 findings/34 filesを修正または部分修正）。
