...
```python
@overload
def show_dialog(self, title: str, widgets: list[Widget[Any]] | Widget[Any], blocking: Literal[True] = True) -> Literal[0]: ...

@overload
def show_dialog(self, title: str, widgets: list[Widget[Any]] | Widget[Any], blocking: Literal[False]) -> int: ...
```
