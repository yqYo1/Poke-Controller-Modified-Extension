...
| # | タスク | フェーズ | 状態 |
|---|------|---------|------|
| 22 | `parse_buttons` 統合 | 15.1.1 | ✅ |
| 23 | `format_default_row()` / `SendFormat::convert_to_default()` 統合 | 15.1.2 | ✅ |
| 24 | `frame_to_base64_jpeg` / `save_frame_as_jpeg` 統合 | 15.1.3 | ✅ |
| 25 | 設定読み込みパス統合 | 15.2.1 | ✅ |
| 26 | Pythonバージョン統一 | 15.2.2 | ✅ |
| 27 | `WindowsNotifier` → `DesktopNotifier` 改名 | 15.3.1 | ✅ |
| 28 | `_3dsController` 命名修正 | 15.3.2 | ✅ |
| 29 | Camera 間接参照最適化 | 15.3.3 | ✅ |
| 30 | `src-tauri` テスト追加 | 15.4.1 | ✅ |
| 31 | `pokecon-pybindings` テスト追加 | 15.4.2 | ✅ |
