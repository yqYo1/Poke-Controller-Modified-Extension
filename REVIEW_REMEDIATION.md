...
- 現在の検証済み修正: **116 / 455 finding、40 / 139 finding-file**（Wave 1/2を継続中、Wave 3はCI timing／normal-ciの5件を完了）。
- Wave 1: **103 / 222 finding、33ファイル**。Wave 2: **8 / 110 finding、5ファイル**。Wave 3: **5 / 123 finding、2ファイル（timing.py、normal-ci.yml完了）**。
...
|---|---|---:|---:|---|---|
| Wave 1 | Rust runtime、settings、worker、server、contracts、Rust tests | 65 | 222 | 部分完了（103/222） | realtime_connection focused compile/test passed; signed commits continue |
...
| 135 | `rust/pokecon/src/worker_binary/dynamic/runtime/lua.rs` | 7 | high,high,high,medium,medium,medium,medium | Wave 1 | 一部修正・検証済み | F1 restricted stdlib sandbox、F2 shared Lua state access serializationを`8f3faa2`で修正、残り5件は未着手。engine 11 tests/clippy passed。 |
